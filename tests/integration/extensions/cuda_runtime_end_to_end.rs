...
fn cuda_extension_pack_path() -> std::path::PathBuf {
    common::repo_root().join("configs/extensions/org_example_runtime_cuda.v1.json")
}
        ...
        &serde_json::json!({
            ...
            "profile": {
              ...
              "extension_requirements": {
                "org.example.runtime.cuda": {
                  "schema_id": "fitctl.extension.org.example.runtime.cuda.requirement.v1",
                  "schema_version": 1,
