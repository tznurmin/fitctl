...
#[test]
fn core_extension_split_uses_core_and_extension_sections() {
    ...
    validate_host_contract(&extension_contract)
        .expect_err("extension payload without basis must fail closed");
}
